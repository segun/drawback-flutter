        ...
        children: <Widget>[
          ...
          _buildSubsectionWithBullets(
            ...
            items: const <String>[
              ...
              'Session logs (user IDs, IP addresses, timestamps) may be retained for up to 90 days for safety and abuse prevention purposes',
              'In cases of reported abuse or suspected child sexual abuse and exploitation (CSAE), we preserve relevant data as required by law and for cooperation with law enforcement',
            ],
          ),
          const SizedBox(height: 24),
          _buildSection(
          ...
          _buildSection(
            context,
            title: '10. Child Safety and Abuse Prevention',
            paragraphs: const <String>[
              'Drawback maintains a zero-tolerance policy regarding child sexual abuse and exploitation (CSAE). We prohibit content or behavior that exploits, endangers, or sexualizes minors.',
            ],
          ),
          const SizedBox(height: 16),
          _buildSubsectionWithBullets(
            context,
            title: '10.1 Reporting and Response',
            items: const <String>[
              'Users can report concerning behavior in-app or by email',
              'Safety contacts: safety@drawback.chat and abuse@drawback.chat',
              'We review reports within 24 hours and prioritize CSAE reports',
              'We preserve evidence and cooperate with law enforcement and mandatory reporting obligations',
            ],
          ),
          _buildSubsectionWithBullets(
            context,
            title: '10.2 Data Used for Safety Investigations',
            items: const <String>[
              'Session metadata (timestamps, user IDs, and IP addresses)',
              'Chat request history and participant information',
              'Account details of reported users',
            ],
          ),
          _buildSection(
            context,
            title: '10.3 Learn More',
            paragraphs: const <String>[],
          ),
          const SizedBox(height: 12),
          Align(
            ...
            child: TextButton(
              ...
              child: Text(
                'See our full CSAE Standards: Child Safety and Abuse Prevention',
          ...
          _buildSection(
            context,
            title: '15. European Union Privacy Rights',
            paragraphs: const <String>[
          ...
          _buildSection(
            context,
            title: '18. Additional Information by Jurisdiction',
            paragraphs: const <String>[],
          ),
          const SizedBox(height: 16),
          _buildSubsectionWithBullets(
            context,
            title: '18.1 United Kingdom (GDPR/DPA 2018)',
            items: const <String>[
          ...
          _buildSubsectionWithBullets(
            context,
            title: '18.3 Australia (Privacy Act 1988)',
            items: const <String>[
